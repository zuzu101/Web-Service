...
<header class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Tambah Section Tentang Kami</h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Tambah Section Tentang Kami</h3>
                ...
                <form action="{{ route('admin.cms.about-section.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        @if(session('success'))
...
<script>
    ...
    // Reset form
    function resetForm() {
        if (confirm('Apakah Anda yakin ingin mereset form? Semua data yang telah diinput akan hilang.')) {
