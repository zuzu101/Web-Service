...
<header class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Buat Section Keunggulan</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.cms.advantage.index') }}">Kelola Keunggulan</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.cms.advantage-section.index') }}">Pengaturan Section</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Buat Section Keunggulan Baru</h3>
                </div>
                
                <div class="card-body">
                    <form action="{{ route('admin.cms.advantage-section.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        
                        <div class="form-group">
                            <label for="title">Judul Section</label>
                            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" 
                                   value="{{ old('title', 'Kenapa Memilih Kami?') }}" 
                                   placeholder="Contoh: Kenapa Memilih Kami?" required>
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('admin.cms.advantage-section.index') }}" class="btn btn-secondary">
