...
<section class="card">
    <article class="card-header">
        <h3 class="card-title">Form Tambah Contact Info</h3>
    ...
    <article class="card-body">
        <form action="{{ route('admin.cms.contact-info.store') }}" method="POST" enctype="multipart/form-data" id="contactInfoForm">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        @enderror
                        <small class="form-text text-muted">
                            Format: JPG, JPEG, PNG, GIF, SVG. Maksimal 2MB.
                        </small>
                    </div>
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Info Urutan:</strong><br>
                        Urutan akan otomatis diatur berdasarkan urutan pembuatan. Gunakan fitur "Atur Urutan" untuk mengubah posisi.
                    </div>
                </div>
            </div>
