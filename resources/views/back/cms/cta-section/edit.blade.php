        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Edit CTA Section</h3>
                ...
                <div class="card-body">
            <form action="{{ route('admin.cms.cta-section.update', $ctaSection->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label class="form-label">Background Image Saat Ini</label>
                            <div class="mt-2">
                                <img src="{{ $ctaSection->background_image_url }}" 
                                     alt="{{ $ctaSection->title }}" 
                                     class="img-thumbnail" 
                        ...
                        <div class="form-group">
                            <label for="background_image" class="form-label">
                                {{ $ctaSection->background_image ? 'Ganti Background Image' : 'Background Image' }}
                            </label>
                            <input type="file" 
                            ...
                            <small class="form-text text-muted">
                                ...
                                {{ $ctaSection->background_image ? 'Kosongkan jika tidak ingin mengganti.' : '' }}
                            </small>
                        ...
                        <div class="form-group">
                            <div id="imagePreview" class="mt-2" style="display: none;">
                                <label class="form-label">Preview Background Baru</label>
                                <div>
                ...
                <div class="form-group mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Update CTA Section
                    </button>
