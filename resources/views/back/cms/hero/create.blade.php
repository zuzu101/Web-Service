...
<section class="card">
    <article class="card-header">
        <h3 class="card-title">Form Tambah Hero Section</h3>
    ...
    <article class="card-body">
        <form action="{{ route('admin.cms.hero.store') }}" method="POST" enctype="multipart/form-data" id="heroForm">
            @csrf
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- Image -->
                    <div class="form-group">
                        <label for="image1">Gambar Hero Section</label>
                        <div class="custom-file">
                            <input type="file" 
                                   ...
                                   name="image1" 
                                   accept="image/*">
                            <label class="custom-file-label" for="image1">Pilih gambar...</label>
                        </div>
                        @error('image1')
            ...
            <div class="form-group mt-4">
                <button type="submit" class="btn btn-primary" id="submitBtn">
                    <i class="fas fa-save"></i> Simpan Hero Section
                </button>
