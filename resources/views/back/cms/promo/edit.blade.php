    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('admin.cms.promo.update', $promo) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="discount_text" 
                                           name="discount_text" 
                                           value="{{ old('discount_text', $promo->discount_text) }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              name="description" 
                                              rows="4" 
                                              placeholder="Rawat laptop Anda secara berkala dan dapatkan diskon menarik...">{{ old('description', $promo->description) }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="button_text" 
                                           name="button_text" 
                                           value="{{ old('button_text', $promo->button_text) }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    @if($promo->image)
                                        <div class="mb-2">
                                            ...
                                            <img src="{{ $promo->image_url }}" alt="Current Image" class="img-thumbnail" style="max-width: 200px;">
                                        </div>
                                    @endif
...
Halo, saya tertarik dengan promo maintenance rutin...">{{ old('whatsapp_template', $promo->whatsapp_template) }}</textarea>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <div id="features-container">
                                    @if(old('features') ?: $promo->features)
                                        @foreach((old('features') ?: $promo->features) as $index => $feature)
...
$(document).ready(function() {
    ...
    $('#image').on('change', function() {
        ...
        if (file) {
            ...
            $('#image-preview').hide();
            $(this).next('.custom-file-label').text('Pilih gambar baru...');
        }
    });
