        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Atur Urutan Layanan</h3>
                    ...
                    <div id="sortable-container">
                        @if($services && $services->count() > 0)
                            @foreach($services as $service)
                                <div class="sortable-item card mb-3" data-id="{{ $service->id }}" data-order="{{ $service->order_number }}">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="mb-0 text-muted">{{ Str::limit($service->description, 100) }}</p>
                                            </div>
                                            <div class="col-auto">
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted">Belum ada data layanan untuk diurutkan.</p>
                                <a href="{{ route('admin.cms.service.create') }}" class="btn btn-primary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (saveBtn) {
        saveBtn.addEventListener('click', function() {
            ...
            fetch('{{ route("admin.cms.service.reorder") }}', {
                method: 'POST',
                headers: {
