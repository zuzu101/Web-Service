        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Tambah Section Step</h3>
                </div>
                
                <form action="{{ route('admin.cms.step-section.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="subtitle" id="subtitle" class="form-control @error('subtitle') is-invalid @enderror" 
                                      rows="3" placeholder="Proses mudah dan cepat untuk mendapatkan layanan terbaik dari kami">{{ old('subtitle') }}</textarea>
                            @error('subtitle')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
